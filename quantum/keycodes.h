...
// Keycodes
    ...
    QK_KEY_INTERRUPT_ON = 0x7C7B,
    QK_KEY_INTERRUPT_OFF = 0x7C7C,
    QK_KEY_INTERRUPT_TOGGLE = 0x7C7D,
    QK_KEY_INTERRUPT_UP_STROKE_TOGGLE = 0x7C7E,
    QK_KB_0 = 0x7E00,
    QK_KB_1 = 0x7E01,
    QK_KB_2 = 0x7E02,
    QK_KB_3 = 0x7E03,
...
// Alias
    ...
    KI_ON      = QK_KEY_INTERRUPT_ON,
    KI_OFF     = QK_KEY_INTERRUPT_OFF,
    KI_TOGG    = QK_KEY_INTERRUPT_TOGGLE,
    KI_USTG    = QK_KEY_INTERRUPT_UP_STROKE_TOGGLE,
};
...
#define IS_QUANTUM_KEYCODE(code) ((code) >= QK_BOOTLOADER && (code) <= QK_KEY_INTERRUPT_UP_STROKE_TOGGLE)
...
#define QUANTUM_KEYCODE_RANGE               QK_BOOTLOADER ... QK_KEY_INTERRUPT_UP_STROKE_TOGGLE
