...
*/
 ...
 [BASE] = LAYOUT_60_ansi( /* Base */
    ...
    KC_LCTL,          KC_LGUI, KC_LALT,                   KC_SPC,             KC_RALT, MO(FN1), MO(FN2), KC_RGHT
),
  /*
  * Layer FN1
  * ,-----------------------------------------------------------------------------------------.
 ...
 [FN1] = LAYOUT_60_ansi( /* FN1 */
    ...
    KC_MEDIA_PLAY_PAUSE, KC_MEDIA_PREV_TRACK, KC_UP,   KC_MEDIA_NEXT_TRACK, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_HOME, KC_END,  KC_PSCR,
 ...
 [FN2] = LAYOUT_60_ansi( /* FN2 */
    ...
    KI_TOGG, _______,    KC_UP,      _______,    _______,    _______, _______, _______, _______, _______,       KC_PSCR,       KC_HOME,       KC_END,        _______,
    KI_RETG, KC_LEFT,    KC_DOWN,    KC_RGHT,    _______,    _______, _______, _______, _______, _______,       KC_PGUP,       KC_PGDN,       _______,
