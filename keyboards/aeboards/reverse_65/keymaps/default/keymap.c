...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
      [0] = LAYOUT_all(
        ...
        MO(1),   KC_LSFT, KC_UP,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(2),
        KC_LCTL, KC_LEFT, KC_DOWN, KC_RGHT, KC_LALT,                   KC_SPC,  KC_SPC,                             KC_RALT, KC_RGUI, KC_RCTL),
