...
#define PRODUCT_ID      0xA653 // AEboards EXT65 Rev3 RGB
#define DEVICE_VER      0x0001
#define MANUFACTURER    AEboards
#define PRODUCT         AEBoards Ext65 RGB
...
#define RGB_BACKLIGHT_BRIGHTNESS 150

// the default effect (RGB test)
#define RGB_BACKLIGHT_EFFECT 255

// the default effect speed (0-3)
#define RGB_BACKLIGHT_EFFECT_SPEED 3
