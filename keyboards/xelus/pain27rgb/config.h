...
#define PRODUCT_ID      0x5027 // (P)ain 27
#define DEVICE_VER      0x0001
#define MANUFACTURER    Xelus
#define PRODUCT         Pain27RGB
#define DESCRIPTION     Pain27RGB
...
#define MATRIX_COL_PINS { D7, E6, B4, B5, C6, D4, B1, B3, B2, D2 }
#define UNUSED_PINS
...
#define RGB_BACKLIGHT_PAIN27RGB

//RGB Underglow defines
#define RGB_DI_PIN D3
#define WS2812_LED_TOTAL 12

//all of them are alphas set include all
#define RGB_UNDERGLOW_ALPHA_TOP_START 0
#define RGB_UNDERGLOW_ALPHA_TOP_END   6
#define RGB_UNDERGLOW_ALPHA_BOT_START 6
#define RGB_UNDERGLOW_ALPHA_BOT_END   12
